...
export default function FindJob() {
    ...
    const [jobsSearch, setIsJobSearch] = useState(true);
    const [jobResults, setIsJobResults] = useState(false);
                    ...
                    <div className="findJobResult">
                        ...
                        <div className="findJobResultFilterDisplay">
                            ...
                            {jobs.map((job) => {
                                ...
                                const { id, title, description, bid, days, skills } = job;
                                const daysLeft = days + ' days left';
                                const skill = 'Skills Required:';
                                const money = '$' + bid + ' - Avg Bid';

                                return (
                                    <div id={id} className="jobResults" onClick={() => this.jobClick()}>
                                        <div className="jobs">
